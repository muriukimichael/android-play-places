...
-->
This readme refers to the 'FragmentView' sample template that has been used to create the UI for this
sample app. It is not integral to the use of the demonstrated features.
